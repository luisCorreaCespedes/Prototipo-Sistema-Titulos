...
function BuscadorModificador() {
    return (
        <div>
            <div>
                <p className='textoExplicacion'>Busca un documento para modificar y/o eliminar de la plataforma.</p>
            </div>
...
export default BuscadorModificador;